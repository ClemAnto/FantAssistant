...
**resta valida per il codice che descriveva**.

**Perche' due.** La presa di ieri sera fotografa la revisione **63**; poche ore dopo e' partito il blocco
delle quindici correzioni (`formazioni-tipo-v1.md` §12.8-§12.9), e la piu' grossa - la mappatura fra
moduli, che era l'identita' su 1331 combinazioni di 1331 e adesso ne sposta 512 - cambia un uomo in
**5 dei 23 club**. Scorare domani la tabella di ieri giudicherebbe una previsione che nessuno sta piu'
spedendo; buttarla via toglierebbe l'unico confronto appaiato che esiste fra le due. Quindi le due
tabelle si scorano ENTRAMBE, sulle stesse distinte, ed e' il primo giudizio che questa board abbia mai
avuto contro il FATTO (§12.7: `press --against press` giudica quella di STAGIONE).

Cosa cambia fra le due prese, club per club — sono tutte e cinque di Serie A, e nessuno dei dodici club
euro si muove:

| club | fuori | dentro |
|---|---|---|
| Lecce | Ndaba | Kaba |
| Parma | Ndiaye, Romero D. | Britschgi, Lontani |
| Sassuolo | Esposito Se. | Bowie |
| Torino | Adams C., Mandragora | Braganca, Cacciamani |
| Udinese | Kabasele | Bertola |
...
| Bologna | serie_a | 2026-09-13 fuori | napoli | `4-2-3-1` | Skorupski, Holm, Helland, Heggem, Miranda J., Pobega, Ferguson, Bernardeschi, Odgaard, Cambiaghi, Piccoli |
...
| Inter | serie_a | 2026-09-14 casa | udinese | `3-5-2` | Martinez Jo., Bisseck, Akanji, Bastoni, Diouf, Barella, Calhanoglu, Sucic P., Dimarco, Esposito F.P., Martinez L. |
...
| Lecce | serie_a | 2026-09-13 casa | monza | `4-2-3-1` | Falcone, Veiga D., Gaspar K., Tiago Gabriel, Gallo, Coulibaly L., Ngom, Pierotti, Kaba, Monteiro J., Stulic |
...
| Monza | serie_a | 2026-09-13 fuori | lecce | `3-4-2-1` | Thiam, Kouadio, Lucchesi, Carboni A., Birindelli, Foe Ondoa, Mout, Mangas, Colpani, Robinson J., Mota |
...
| Parma | serie_a | 2026-09-14 fuori | como | `3-4-2-1` | Corvi, Delprato, Troilo, Valeri, Britschgi, Ordonez C., Keita M., Valenti, Fabbian, Tourè E., Lontani |
...
| Roma | serie_a | 2026-09-14 fuori | torino | `3-4-2-1` | Svilar, Mancini, N'Dicka, Hermoso, Lulli, Cristante, De Roon, Wesley, Dybala, Mora, Malen |
...
| Torino | serie_a | 2026-09-14 casa | roma | `3-1-4-2` | Mascardi, Comert, Ismajli, Comuzzo, Gineitis, Fortini, Braganca, Fitz-Jim, Cacciamani, Simeone, Vlasic |
...
Identico a ieri, e su tutt'e due le tabelle. Per club: quanti degli undici previsti sono nella distinta
vera (su 11), e se il modulo coincide. Il null e' l'undici che ha cominciato l'ULTIMA partita di quel
club, letto dallo stesso livello per-partita — un numero senza il suo null non e' interpretabile.

**Cosa questo confronto puo' e non puo' dire.** Con 23 club e 5 che cambiano un uomo, la differenza fra
le due prese e' larga **9 nomi su 253**: non e' un campione che possa promuovere o bocciare la mappatura,
ed e' scritto qui perche' domani non venga letto come un verdetto. La mappatura sta in piedi
sull'aritmetica (uno slot di difesa non puo' votare per un posto di centrocampo) e sui 512 spostamenti su
1331, non su questa tabella; questa dice se il disegno regge contro il fatto, che e' un'altra domanda.
