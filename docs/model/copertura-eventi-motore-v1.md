...
| La maglia del portiere che cambia mano a inizio stagione | **MISURATO e RESPINTO** (07/09/2026) | Dall'ipotesi dell'operatore sul caso Meret/Milinkovic-Savic («due partite da 90' contro zero dovrebbero bastare»): sulle coppie di portieri di un club dove dopo k giornate il leader VISTO ≠ il leader del PRIOR (prior ≥ 15 presenze), la maglia resta a chi l'ha presa **10/18 a k=2** (una monetina), 10/15 a k=3, 8/12 a k=4. Il testimone chiave è la STESSA coppia un anno prima: 2025-26 Napoli, Meret prende le prime 2 e Milinkovic-Savic torna e ne gioca 27 contro 9 — più Sportiello→Gollini, Perin→Szczesny, Musso→Carnesecchi, Zoet→Provedel, Sava→Okoye. Il prior pooled (K=5 pannello, R20K10 motore) è la base rate giusta anche per i portieri: la curva del guadagno per K ha la stessa forma dei ruoli di movimento (misurata a parte, stesso banco). Nessun K speciale, nessuna regola di maglia; a convergere ci pensano le giornate |
