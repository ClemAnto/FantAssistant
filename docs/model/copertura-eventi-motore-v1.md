...
| Il NUOVO ARRIVATO che questo campionato non ha mai visto giocare | **REPORTING, due bracci, e su euro spento** (10/09/2026) | `modules/abroad.py`, `desc_abroad_*`, `letture-app-v1.md` §39. 188 quotati su 531 non hanno un voto dell'anno prima e il foglio li ordina con una COSTANTE — `r(quota all'estero, est_pv)` = **+0,05**. Su 803 (uomo, stagione), esito «20+ presenze e fantamedia 6,0+», rankato dentro ruolo e stagione: dai cinque coperti paga la **quota giocata** (1,41x) e i bonus NO (**1,03x**, e **0,70x** fra i quotati bassi); da fuori paga **gol+assist** (1,35x) e la quota meno (1,28x). **Il Qt.I da solo fa 1,41x e 1,51x, quindi non battiamo il mercato**: si compra che quegli uomini abbiano dei numeri. Su EURO i bracci si **invertono** (1,27 vs 1,35 e 1,37 vs 1,12) e il marchio è spento perché n=151/168 non li separa — i NUMERI viaggiano lì comunque, il VERDETTO no. Portieri esclusi (p90 di ruolo 0,03 g+a/90), giovanili escluse dall'**età mediana** della competizione, livello del campionato **non letto** (sui tre δ misurati il legame è invertito) |
